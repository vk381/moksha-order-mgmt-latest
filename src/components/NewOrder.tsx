...
const NewOrder: React.FC = () => {
  ...
  const { register, control, handleSubmit, formState: { errors } } = useForm<NewOrderForm>({
    ...
    defaultValues: {
      orderDetails: [{ description: '', images: [] }],
    },
  });
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="divide-y divide-gray-200">
              ...
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-sm sm:leading-7">
                <div className="flex flex-col">
                  ...
                  <button
                    type="button"
                    onClick={() => append({ description: '', images: [] })}
              ...
              <div className="pt-4 flex items-center space-x-4">
                <button
                  type="button"
                  onClick={() => navigate('/')}
                  className="flex justify-center items-center w-full text-gray-900 px-4 py-2 rounded-md focus:outline-none"
                >
                  <X className="w-5 h-5 mr-2" /> Cancel
                </button>
                <button
                  type="submit"
                  className="bg-indigo-500 flex justify-center items-center w-full text-white px-4 py-2 rounded-md focus:outline-none"
                >
                  Create Order
                </button>
              </div>
